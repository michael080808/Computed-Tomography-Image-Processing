...
# 保存Numpy以备以后调用
numpy.save("Figure_3_RL.npy", image_target)
scipy.io.savemat("Figure_3_RL.mat", {"I3RL": image_target[int(512 - 182 + delta_y):int(512 + 183 + delta_y), int(512 - 182 + delta_x):int(512 + 183 + delta_x)]})
...
matplotlib.pyplot.savefig('Figure_3_RL_512x512.png',dpi=75)
...
matplotlib.pyplot.colorbar()
matplotlib.pyplot.savefig('Figure_3_RL_365x365.png',dpi=75)
