...
table = wookbook.sheet_by_name('附件2')
...
# 保存Numpy以备以后调用
numpy.save("Figure_1.npy", image_target)
scipy.io.savemat("Figure_1.mat", {"I1": image_target})
...
matplotlib.pyplot.savefig('Figure_1_512x512.png',dpi=75)
...
matplotlib.pyplot.colorbar()
matplotlib.pyplot.savefig('Figure_1_365x365.png',dpi=75)
