...
table = wookbook.sheet_by_name('附件3')
...
def convolution(index):
    ...
    if index == 0:
        ...
        convol = -1.0 / (index * index * math.pi * math.pi)
    return convol
...
# 保存Numpy以备以后调用
numpy.save("Figure_2.npy", image_target)
scipy.io.savemat("Figure_2.mat", {"I2": image_target[int(512 - 182 + delta_y):int(512 + 183 + delta_y), int(512 - 182 + delta_x):int(512 + 183 + delta_x)]})
...
matplotlib.pyplot.savefig('Figure_2_512x512.png',dpi=75)
...
matplotlib.pyplot.colorbar()
matplotlib.pyplot.savefig('Figure_2_365x365.png',dpi=75)
